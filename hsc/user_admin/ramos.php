...
if(isset($_SESSION['usuario']))
{
  ...
  if($_SESSION['tipoUsuario'] == 2 || $_SESSION['tipoUsuario'] == 3)
  {
    if(isset($_POST['agrega']) && $_POST['agrega'] == 'Agregar')
    {
      ...
      {
        if($_POST['codigo'] != '' && $_POST['nombre'] != '' && $_POST['tipo'] != 0 && $_POST['teo'] != '' && $_POST['ayu'] != '' && $_POST['lab'] != '' && $_POST['tall'] != '' && $_POST['cre'] != '')
        {
          $answer = $usuario->agregarRamo($_POST['codigo'],$_POST['nombre'],$_POST['tipo'],$_POST['teo'],$_POST['ayu'],$_POST['lab'],$_POST['tall'],$_POST['cre']);
        }
        else
        {
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <table>
        <tr><td>Codigo</td><td>Nombre</td><td>Tipo</td><td>Teó.</td><td>Ayu.</td><td>Lab.</td><td>Tall.</td><td>Créd.</td><td></td></tr> 
        <form method="post" name="agregar" target="_self">
            ...
            <td><select name="tipo"><option value="0">Escoger tipo</option>
              <?php obtenerTiposRamo();?></select></td>
        ...
        <?php
          echo '<table>';
          echo '<tr><td>Codigo</td><td>Nombre</td><td>Tipo</td><td>Teó.</td><td>Ayu.</td><td>Lab.</td><td>Tall.</td><td>Créd.</td><td>Relacionar</td><td>Eliminar</td></tr>';     
          $usuario->verRamos();
          echo '</table>';
        ?>
        </ul>
